...
`md-to-rag init` creates `corpus_manifest.json` and the artifact directories.
The pipeline then fills this layout as commands run:

```text
corpus_manifest.json
source/
  source_manifest.jsonl        # generated by ingest
documents/
  documents.jsonl              # generated by ingest
chunks/
  chunks.jsonl                 # generated by chunk
embeddings/
  embeddings.jsonl             # generated by embed
indexes/
  index_manifest.json          # generated by index
  vectors.jsonl                # generated by index
reports/
```
